...
class Generator(chainer.Chain):
    def __init__(self):
        ...
        with self.init_scope():
            self.l0 = L.Linear(100, NEURON_SIZE*IMAGE_SIZE *
                               IMAGE_SIZE//8//8, initialW=w)
    ...
    def __init__(self):
        ...
        with self.init_scope():
            self.c0_0 = L.Convolution2D(
                IN_CH, NEURON_SIZE//8, 3, 1, 1, initialW=w)
            ...
            self.l4 = L.Linear(NEURON_SIZE * IMAGE_SIZE * IMAGE_SIZE//8//8,
                               1, initialW=w)
